...
<div class="wrapper bgded overlay" style="background-image:url('<?= base_url() ?>asset/images/demo/backgrounds/01.png');">
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <ul class="nospace group overview">
      <li class="one_third">
        <figure><a href="#"><img src="<?= base_url() ?>asset/images/demo/348x261.png" alt=""></a>
          <figcaption>
...
<div class="wrapper gradient">
  <section id="testimonials" class="hoc container clear"> 
    ...
    <article class="one_half first"><img src="<?= base_url() ?>asset/images/demo/100x100.png" alt="">
    ...
    <article class="one_half"><img src="<?= base_url() ?>asset/images/demo/100x100.png" alt="">
...
<!-- JAVASCRIPTS -->
<script src="<?= base_url() ?>asset/scripts/jquery.min.js"></script>
<script src="<?= base_url() ?>asset/scripts/jquery.backtotop.js"></script>
<script src="<?= base_url() ?>asset/scripts/jquery.mobilemenu.js"></script>
</body>
</html>