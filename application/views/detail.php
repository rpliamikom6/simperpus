                    ...
                    <div id="product-feature">
                        ...
                        <div class="col-12 product-image-thumbs">
                            <div class="d-flex flex-wrap justify-content-start">
                                <div class="product-image-thumb active"><img class="img-fluid" src="<?= base_url('assets');?>/dist/img/prod-1.jpg"
                                        alt="Product Image"></div>
                                <div class="product-image-thumb"><img class="img-fluid" src="<?= base_url('assets');?>/dist/img/prod-2.jpg"
                                        alt="Product Image"></div>
                                <div class="product-image-thumb"><img class="img-fluid" src="<?= base_url('assets');?>/dist/img/prod-3.jpg"
                                        alt="Product Image"></div>
                                <div class="product-image-thumb"><img class="img-fluid" src="<?= base_url('assets');?>/dist/img/prod-4.jpg"
                                        alt="Product Image"></div>
                                <div class="product-image-thumb"><img class="img-fluid" src="<?= base_url('assets');?>/dist/img/prod-5.jpg"
                                        alt="Product Image"></div>
                            </div>
                        </div>
                        <script>
